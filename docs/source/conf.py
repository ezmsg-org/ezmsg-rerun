...
try:
    from ezmsg.rerun.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-rerun/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.rerun {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-rerun",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-rerun/blob/{branch}/"
